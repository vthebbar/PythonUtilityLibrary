...
# **** This is Enhanced function *******
# ****For Basic function   refer to file -> " MultiSelectInputBox.py "  ****


def select_values(elements_list, values_to_select):

    print("Total number of elements=", len(elements_list))
    print("Number of elements to be selected=", len(values_to_select))
...
select_values(elements, ['Administrators','Forum Moderators','Salesman','Vendors'])

driver.save_screenshot("..\\Screenshots\\MultiSelectInputBox_E1.png")
driver.close()